...
export const properties: Property[] = [
  {
    ...
    type: 'apartment',
    status: 'for-sale',
    description: 'Premium 3 BHK apartment in the heart of Whitefield with modern amenities and excellent connectivity to IT parks.',
    features: ['Swimming Pool', 'Garden', 'Parking', 'Security', 'Gym', 'Club House', 'Children Play Area', 'Jogging Track'],
    yearBuilt: 2024,
    parking: 2,
  ...
  },
  {
    ...
    type: 'apartment',
    status: 'for-sale',
    description: 'Premium 3 BHK apartment in Hebbal with modern amenities and beautiful garden views.',
    features: ['Swimming Pool', 'Garden', 'Parking', 'Security', 'Gym', 'Club House', 'Jogging Track'],
    yearBuilt: 2024,
    parking: 2,
  ...
  },
  {
    ...
    type: 'apartment',
    status: 'for-sale',
    description: 'Beautiful 2 BHK apartment in the heart of Koramangala with all modern amenities and great connectivity.',
    features: ['Gym', 'Garden', 'Power Backup', 'Covered Parking', 'Club House', 'Children Play Area'],
    yearBuilt: 2024,
    parking: 1,
  ...
  },
  {
    ...
    type: 'apartment',
    status: 'for-sale',
    description: 'Exquisite 4 BHK apartment in Indiranagar with luxury amenities and prime location in the city center.',
    features: ['Swimming Pool', 'Home Theater', 'Garden', 'Parking', 'Security', 'Gym', 'Club House', 'Power Backup'],
    yearBuilt: 2024,
    parking: 2,
